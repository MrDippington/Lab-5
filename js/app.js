...
function multiply(a, b) { //eslint-disable-line
    ...
    var multiString = 'The product of ' + a + ' and ' + b + ' is ' + multiplyProduct + '.';
    return [multiplyProduct, multiString];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var finalSumString = a + ' and ' + b + ' and ' + c + ' sum to ' + finalSum + '.';
    var finalProductString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + finalProduct + '.';
    return [finalSum, finalProduct, finalSumString, finalProductString];
